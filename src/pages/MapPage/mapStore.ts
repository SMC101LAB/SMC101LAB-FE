...
//   setMapTypeId: (typeId: naver.maps.MapTypeId) => void;
...
//     const { fetchSlopes, userLocation, mapInstance } = get();
...
//     const { mapInstance, selectedMarkerId } = get();
...
//   moveToMyLocation: () => {
//     const { mapInstance, userLocation, fetchSlopes } = get();
